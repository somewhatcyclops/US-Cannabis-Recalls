...
That means that it has many known issues. Given the hundreds of hours I've spent curating the data, you'll have to forgive those, and hopefully the next time I sit down to work on this data I'll be fixing some of the major ones. 
